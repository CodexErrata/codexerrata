...
<p>En kväll satt jag, mamman, och dottern och diskuterade några jobbsökande som vi träffat tidigare samma dag. Mamman berättade att den viktigaste faktorn bakom varför jag fick jobbet, och varför det ≈åtta månader in hade fungerat så väl, var att jag var så ärlig.
...
Hur som. Under min tid hos den familjen fick jag mycket insyn i deras politiska inställningar. Moderater brydde sig inte om hemlösa. De ville se barn gå hungriga. De ville att sjukvård skulle vara ett privilegium för de rika. Det motsatta gällde för deras respektiva på andra sidan det politiska spektrumet. 
...
Om vi accepterar tesen att det finns en 1:1 relation mellan godhet och omfördelningspolitik, hur mycket skiljer det egentligen mellan moder Teresa-sidan och den kallhjärtade kapitalistmonstersidan? 
 ...
 <div class="sidenote-row">
    <div style="margin-top: 120px;">Löfven II (S + MP) budgetproposition 2022, kontra moderaternas skuggproposition. Data för nyare budgetar lyckades jag inte hitta i CSV-format, men samma fenomen verkar stämma oavsett vilket år man kollar på.     
</div>
    <div>

![Budgetjämförelse A vs B](images/budget-chart.svg)
